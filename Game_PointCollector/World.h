...
public:
	...
	void createNodeAndLinks();
	bool isTouching(Disk disk1, Disk disk2);
	ObjLibrary::Vector3 calculateNodePosition(Disk disk1, Disk disk2);
	int addNode(ObjLibrary::Vector3 position, Disk disk,int diskId,int nodeId);
	double calculateWeightBwDisks(int node_i, int node_j, int diskId_i, int diskId_j);
	double calculateWeightBwSameDisks(int node_i, int node_j, int diskId_i);
	void addLink(int node_i, int node_j, int diskIdi, int diskIdj, ObjLibrary::Vector3 position_i, ObjLibrary::Vector3 position, double weightij);
