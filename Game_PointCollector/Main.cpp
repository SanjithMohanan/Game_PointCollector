...
int main (int argc, char* argv[])
{
	...
	initDisplay();
	Game::loadModels();
	//g_game.init("Worlds/Basic.txt");
	//g_game.init("Worlds/Dense.txt");
	//g_game.init("Worlds/Icy.txt");
	//g_game.init("Worlds/Leafy.txt");
	//g_game.init("Worlds/Rocky.txt");
	//g_game.init("Worlds/Sandy.txt");
	g_game.init("Worlds/Simple.txt");
	//g_game.init("Worlds/Small.txt");
	//g_game.init("Worlds/Sparse.txt");
	//g_game.init("Worlds/Twisted.txt");
	//g_game.init("Worlds/150Disks.txt");
	//g_game.init("Worlds/175Disks.txt");
	//g_game.init("Worlds/200Disks.txt");
	//g_game.init("Worlds/250Disks.txt");
	//g_game.init("Worlds/316Disks.txt");
	//g_game.init("Worlds/421Disks.txt");
	//g_game.init("Worlds/707Disks.txt");
